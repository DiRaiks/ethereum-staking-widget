...
import { ReactComponent as IconMevDark } from 'assets/vault-banner/icon-mev-dark.svg?react';
import { ReactComponent as IconP2PDark } from 'assets/vault-banner/icon-p2p-dark.svg?react';
import { ReactComponent as IconRe7Dark } from 'assets/vault-banner/icon-re7-dark.svg?react';
import { ReactComponent as IconSteakhouseDark } from 'assets/vault-banner/icon-steakhouse-dark.svg?react';

import { ReactComponent as IconMevLight } from 'assets/vault-banner/icon-mev-light.svg?react';
import { ReactComponent as IconP2PLight } from 'assets/vault-banner/icon-p2p-light.svg?react';
import { ReactComponent as IconRe7Light } from 'assets/vault-banner/icon-re7-light.svg?react';
import { ReactComponent as IconSteakhouseLight } from 'assets/vault-banner/icon-steakhouse-light.svg?react';
